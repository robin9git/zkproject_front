        ...
        success:function (data){
            ...
            if (data) {
            	var res = '';
	        		...
	        		res += 		"</p>";
	        		res += 		"<a class='body1_in_left_a' href='index_hydt_xq.html?id="+(data[0].id!=undefined?data[0].id:'')+"'><span>查看详情</span></a>"
	        		res += "</div>";
	        		//图片
            ...
            if (data) {
            	...
            	var res = '';
            		for(var i=0;i<data.length;i++){
    	        		...
    	        		res += "</div>";
    	        		//内容
    	        		res += "<a href='index_hydt_xq.html?id="+(data[i].id!=undefined?data[i].id:'')+"' class='body2_li_r'>";
