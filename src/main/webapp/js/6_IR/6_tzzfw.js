...
function getMoreNews(pageCurrent,flag){
	...
	var data = [{"publicTime":"2016-03-07","id":"123","title":"2016年上半年投资者业绩调研会取得圆满成功","content":"应该如何从煤化工“三废”中淘宝？"}
	,{"publicTime":"2016-03-07","id":"123","title":"2016年上半年投资者业绩调研会取得圆满成功","content":"应该如何从煤化工“三废”中淘宝？"}
	,{"publicTime":"2016-03-07","id":"123","title":"2016年上半年投资者业绩调研会取得圆满成功","content":"应该如何从煤化工“三废”中淘宝？"}
	,{"publicTime":"2016-03-07","id":"123","title":"2016年上半年投资者业绩调研会取得圆满成功","content":"应该如何从煤化工“三废”中淘宝？"}
	,{"publicTime":"2016-03-07","id":"123","title":"2016年上半年投资者业绩调研会取得圆满成功","content":"应该如何从煤化工“三废”中淘宝？"}];
	
	var res = '';
	var hr = "http://114.242.195.204:81/upload/files/files/201503.pdf";
	for(var i=0;i<data.length;i++){
		...
		res += "</div>";
		//内容
		res += "<a href='"+hr+"' class='body2_li_r'>";
...
//		res += 		"</p>";
		...
		res += "<div style='height: 56px;position: relative;margin-top: 10px;'>";
		
		res += "<span>发布者：中科合成油工程股份有限公司</span>";
		res += "<img style='position: absolute;right: 55px;' src='/imgs/6_IR/icon_pdf.png' />";
		res += "</div>";
