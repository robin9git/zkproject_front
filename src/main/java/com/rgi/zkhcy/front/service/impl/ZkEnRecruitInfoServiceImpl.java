...
import com.rgi.zkhcy.front.module.dao.ZkEnRecruitInfoDao;
import com.rgi.zkhcy.front.service.common.BaseService;
import com.rgi.zkhcy.front.service.service.ZkEnRecruitInfoService;
...
public class ZkEnRecruitInfoServiceImpl extends BaseService implements ZkEnRecruitInfoService {

	@Autowired
	private ZkEnRecruitInfoDao zkEnRecruitInfoDao;
	/**
	 * 
	 * @author JQchen
	 * @describe 通过ID查询对象 
	...
	public ZkRecruitInfoData selectZkRecruitInfoById(Object id) {
		...
		return zkEnRecruitInfoDao.queryById(id);
	}
	...
	public List<ZkRecruitInfoData> selectZkRecruitInfoList() {
		...
		return zkEnRecruitInfoDao.queryAllList();
	}
