...
import com.rgi.zkhcy.front.module.dao.ZkLogoDao;
...
public class ZkLogoServiceImpl extends BaseService implements ZkLogoService {
	@Autowired
	private ZkLogoDao zkLogoDao;
	...
	public List<ZkLogoData> getLogoList() {
		...
		List<ZkLogoData> list=zkLogoDao.queryAllList();
		return list;
	}
