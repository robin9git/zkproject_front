...
public class ZkEnAttachmentServiceImpl extends BaseService implements ZkEnAttachmentSerivce{
	@Autowired
	...
	public List<ZkAttachmentData> getIndexVideoList() {
		...
		return zkEnAttachmentDao.queryListByObject(zkAttachment);
	}
	...
	public List<ZkAttachmentData> queryByMenu(){
		return zkEnAttachmentDao.queryByMenu();
	}
}
