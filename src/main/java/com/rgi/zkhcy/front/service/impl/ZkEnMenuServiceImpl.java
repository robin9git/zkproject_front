...
public class ZkEnMenuServiceImpl extends BaseService implements ZkEnMenuService {
	...
	public ZkMenuData selectZkMenuById(Object id) {
		...
		return zkEnMenuDao.queryById(id);
	}
	/**
	 * 
	 * @author JQchen
	...
	public List<ZkMenuData> getFootSubData(String parentId,List<ZkMenuData> ssublist){
		...
		List<ZkMenuData> menuList=zkEnMenuDao.queryListByObject(menu);
	...
	public List<ZkMenuData> selectMenuListByParentId(String parentId){
		...
		return zkEnMenuDao.queryListByObject(zkMenu);
	}
