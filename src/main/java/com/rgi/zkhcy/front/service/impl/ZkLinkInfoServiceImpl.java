...
import com.rgi.zkhcy.front.module.dao.ZkLinkInfoDao;
...
public class ZkLinkInfoServiceImpl extends BaseService implements ZkLinkInfoService {

	@Autowired
	private ZkLinkInfoDao zkLinkInfoDao;
	/**
	 * 
	 * @author JQchen
	 * @describe 通过ID查询对象 
	...
	public ZkLinkInfoData selectZkLinkInfoById(Object id) {
		...
		return zkLinkInfoDao.queryById(id);
	}
	/**
	 * 
	 * @author JQchen
	...
	public List<ZkLinkInfoData> selectZklinkInfoList() {
		...
		return zkLinkInfoDao.queryAllList();
	}
