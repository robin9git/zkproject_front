 ...
 */
@Controller
@RequestMapping("/zkEnRecruitInfo")
public class ZkEnRecruitInfoController extends BaseController{

	@Autowired
	private ZkEnRecruitInfoService zkEnRecruitInfoService;
	...
	public Object selectZkRecruitInfoList(){
		...
		List<ZkRecruitInfoData> list=zkEnRecruitInfoService.selectZkRecruitInfoList();
