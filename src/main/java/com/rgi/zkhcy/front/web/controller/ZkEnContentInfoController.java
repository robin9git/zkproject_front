 ...
 */
@Controller
@RequestMapping("/zkEnContentInfo")
public class ZkEnContentInfoController extends BaseController{
	
	@Autowired
	private ZkEnContentInfoService zkEnContentInfoService;
	
	@Autowired
	private ZkEnContentImgService zkEnContentImgService;
	...
	public Object selectZkContentInfoById(@RequestParam(value="id")String id) {
		...
		ZkContentInfoData zkContentInfoData=zkEnContentInfoService.selectZkContentInfoById(id);
		if(zkContentInfoData!=null){
			...
			map.put("imgs", zkEnContentImgService.selectContentImgByContentId(zkContentInfoData.getId()));
		}
		return map;
	}
	/**
	...
	public Object selectIndexNewsContent() {
		...
		List<ZkContentInfoData> list=zkEnContentInfoService.selectIndexNewsContent();
	...
	@ResponseBody
	public Object selectContentByMenuId(@RequestParam(value="menuId")String menuId) {
		log.info("内容信息模块---Controller---根据菜单ID查询内容列表 ---接收请求对象:menuId{}"+menuId);
		List<Map<String,Object>> mapList=new ArrayList<Map<String,Object>>();
		List<ZkContentInfoData> list=zkEnContentInfoService.selectContentByMenuId(menuId);
		if(list!=null&&list.size()>0){
			for (ZkContentInfoData zkContentInfoData : list) {
				Map<String, Object>map=new HashMap<String, Object>();
				map.put("id",zkContentInfoData.getId());
	...
	public Object selectContentForLevel1ByMenuId(@RequestParam(value="menuId")String menuId) {
		...
		List<Map<String,Object>> mapList=new ArrayList<Map<String,Object>>();
		List<ZkContentInfoData> list=zkEnContentInfoService.selectContentForLevel1ByMenuId(menuId);
		if(list!=null&&list.size()>0){
			for (ZkContentInfoData zkContentInfoData : list) {
				Map<String, Object>map=new HashMap<String, Object>();
				map.put("id",zkContentInfoData.getId());
	...
	public Object selectContentForLevel2ByMenuId(@RequestParam(value="menuId")String menuId) {
		...
		List<Map<String,Object>> mapList=new ArrayList<Map<String,Object>>();
		List<ZkContentInfoData> list=zkEnContentInfoService.selectContentForLevel2ByMenuId(menuId);
		if(list!=null&&list.size()>0){
			for (ZkContentInfoData zkContentInfoData : list) {
				Map<String, Object>map=new HashMap<String, Object>();
				map.put("id",zkContentInfoData.getId());
	...
	public Object selectContentForLevel3ByMenuId(@RequestParam(value="menuId")String menuId) {
		...
		List<Map<String,Object>> mapList=new ArrayList<Map<String,Object>>();
		List<ZkContentInfoData> list=zkEnContentInfoService.selectContentForLevel3ByMenuId(menuId);
		if(list!=null&&list.size()>0){
			for (ZkContentInfoData zkContentInfoData : list) {
				Map<String, Object>map=new HashMap<String, Object>();
				map.put("id",zkContentInfoData.getId());
	...
	public Object selectContentNewsInfo(@RequestParam(value="menuId")String menuId,@RequestParam(value="num")String num) {
		...
		log.info("内容信息模块---Controller---根据菜单ID查询一级内容 ---接收请求对象:menuId{}"+menuId);	
		List<Map<String,Object>> mapList=new ArrayList<Map<String,Object>>();
		List<ZkContentInfoData> list=zkEnContentInfoService.selectContentNewsInfo(menuId);
	...
	public Object selectContentByMenuIdDate(@RequestParam(value="menuId")String menuId,@RequestParam(value="date")String date) {
		...
		List<Map<String,Object>> mapList=new ArrayList<Map<String,Object>>();
		List<ZkContentInfoData> list=zkEnContentInfoService.selectContentByMenuIdDate(menuId, date);
		if(list!=null&&list.size()>0){
			for (ZkContentInfoData zkContentInfoData : list) {
				Map<String, Object>map=new HashMap<String, Object>();
				map.put("id",zkContentInfoData.getId());
	...
	public Object getZkContentInfoList3ById(@RequestParam(value="menuId")String menuId) {
		...
		List<ZkContentInfoData> list = zkEnContentInfoService.getZkContentInfoList3ById(ent);
