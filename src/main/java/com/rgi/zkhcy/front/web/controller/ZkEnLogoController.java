 ...
 */
@Controller
@RequestMapping("/zkEnLogo")
public class ZkEnLogoController extends BaseController{
	@Autowired
	private ZkEnLogoService zkEnLogoService;
	...
	public Object getZkLogo(){
		...
		List<ZkLogoData>list=zkEnLogoService.getLogoList();
