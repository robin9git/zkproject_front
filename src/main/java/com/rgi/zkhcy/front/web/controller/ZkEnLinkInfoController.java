 ...
 */
@Controller
@RequestMapping("/zkEnLinkInfo")
public class ZkEnLinkInfoController extends BaseController {

	@Autowired
	private ZkEnLinkInfoService zkEnLinkInfoService;
	...
	public Object selectZkLinkInfoList() {
		...
		List<ZkLinkInfoData> list = zkEnLinkInfoService.selectZklinkInfoList();
		
		
		
		
//		if (list != null && list.size() > 0) {
//			for (final Integer category : Lists.newArrayList(ZkLinkInfoUtil.CATEGROY_2, ZkLinkInfoUtil.CATEGROY_3,ZkLinkInfoUtil.CATEGROY_4)) {
