...
import com.rgi.zkhcy.front.service.service.ZkEnMenuService;
 ...
 */
@Controller
@RequestMapping("/zkEnMenu")
public class ZkEnMenuController extends BaseController{

	@Autowired
	private ZkEnMenuService zkEnMenuService;
	...
	public Object getHeadMenuList(){
		...
		List<Map<String, Object>> map=zkEnMenuService.selectHeadMenuListByType();
		return map;
	}
	/**
	 * 
	...
	public Object getFootMenuList(){
		...
		List<Map<String, Object>> map=zkEnMenuService.selectFootMenuListByType();
		return map;
	}
	/**
	 * 
	...
	public Object selectHeadMenuByParentId(@RequestParam(value="parentId")String parentId){
		...
		List<Map<String, Object>>map=zkEnMenuService.selectHeadMenuByParentId(parentId);
		return map;
	}
	/**
	 * 
	...
	public Object selectOtherMenuListByParentId(@RequestParam(value="parentId")String parentId){
		...
		List<Map<String, Object>>map=zkEnMenuService.selectOtherMenuListByParentId(parentId);
		return map;
	}
	...
	public Object selectMenuListByParentId(@RequestParam(value="parentId")String parentId){
		log.info("中科菜单模块---Controller--- 查询子其他菜单列表   ---接收请求对象:parentId{}"+parentId);
		List<ZkMenuData> list=zkEnMenuService.selectMenuListByParentId(parentId);
		return list;
	}
}
