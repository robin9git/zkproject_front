 ...
 */
@Controller
@RequestMapping("/zkAttachment")
public class ZkAttachmentController extends BaseController {
	@Autowired
	...
	public Object  getIndexVideoList() {
		...
		List<ZkAttachmentData> list=zkAttachmentSerivce.getIndexVideoList();
	...
	public Object getIndexMenu1List(@RequestParam(value="year") String year) {
		...
		List<Map<String,Object>> mapList=new ArrayList<Map<String,Object>>();
		List<ZkAttachmentData> list=zkAttachmentSerivce.getIndexMenu1List(year);
		if(list!=null&&list.size()>0){
	...
	public Object  getIndexMenu2List() {
		...
		List<Map<String,Object>> mapList=new ArrayList<Map<String,Object>>();
		List<ZkAttachmentData> list=zkAttachmentSerivce.getIndexMenu2List();
		if(list!=null&&list.size()>0){
			for (ZkAttachmentData zkAttachmentData : list) {
				Map<String,Object> map=new HashMap<String, Object>();
				map.put("id", zkAttachmentData.getId());
	...
	public Object  getMenuDate() {
		log.info("文件模块---Controller---获取合成油世界列表  ---接收请求对象");
		List<Map<String,Object>> mapList=new ArrayList<Map<String,Object>>();
		List<ZkAttachmentData> list=zkAttachmentSerivce.queryByMenu();
		if(list!=null&&list.size()>0){
			for (ZkAttachmentData zkAttachmentData : list) {
				Map<String,Object> map=new HashMap<String, Object>();
				map.put("id", zkAttachmentData.getId());
	...
	public Object  getIndexMenu3List() {
		...
		List<Map<String,Object>> mapList=new ArrayList<Map<String,Object>>();
		List<ZkAttachmentData> list=zkAttachmentSerivce.getIndexMenu3List();
		if(list!=null&&list.size()>0){
			for (ZkAttachmentData zkAttachmentData : list) {
				Map<String,Object> map=new HashMap<String, Object>();
				map.put("id", zkAttachmentData.getId());
	...
	public Object getIndexMenu5List() {
		...
		List<Map<String,Object>> mapList=new ArrayList<Map<String,Object>>();
		List<ZkAttachmentData> list=zkAttachmentSerivce.getIndexMenu5List();
		if(list!=null&&list.size()>0){
			for (ZkAttachmentData zkAttachmentData : list) {
				Map<String,Object> map=new HashMap<String, Object>();
				map.put("id", zkAttachmentData.getId());
