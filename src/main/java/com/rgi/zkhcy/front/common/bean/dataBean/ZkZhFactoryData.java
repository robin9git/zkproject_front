...
public class ZkZhFactoryData {
	...
	private List<String> imgs;//   图片展示
	
	private Integer isProDebriefing;//是否首页展示
	private String proDebriefing;//项目进展
	private String proDebPic;//进展图片
	
	public String getProDebPic() {
		return proDebPic;
	}
	public void setProDebPic(String proDebPic) {
		this.proDebPic = proDebPic;
	}
	public Integer getIsProDebriefing() {
		return isProDebriefing;
	}
	public void setIsProDebriefing(Integer isProDebriefing) {
		this.isProDebriefing = isProDebriefing;
	}
	public String getProDebriefing() {
		return proDebriefing;
	}
	public void setProDebriefing(String proDebriefing) {
		this.proDebriefing = proDebriefing;
	}
