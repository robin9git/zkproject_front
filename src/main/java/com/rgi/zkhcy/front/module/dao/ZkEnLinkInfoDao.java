...
import com.rgi.zkhcy.front.common.bean.ZkLinkInfo;
...
/**
 * 
 * @ClassName ZkLinkInfoDao
 * @describe 友情链接
 * @author JQchen
 * @version 2015-11-24 下午4:57:30
 */
@MyBatisDao
public interface ZkEnLinkInfoDao extends BaseDao<ZkLinkInfo,ZkLinkInfoData> {
